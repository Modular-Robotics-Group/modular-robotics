...
const _boxGeometryVertices = [
    ...
    // -, -, -, // G
    // +, -, -, // H
    { pos: [-1.0,  1.0,  1.0], uv: [0.0, 1.0] }, // 0  | A | +z face
    { pos: [-1.0, -1.0,  1.0], uv: [0.0, 0.0] }, // 1  | C
    { pos: [ 1.0,  1.0,  1.0], uv: [1.0, 1.0] }, // 2  | B
    { pos: [ 1.0,  1.0,  1.0], uv: [1.0, 1.0] }, // 3  | B
    { pos: [-1.0, -1.0,  1.0], uv: [0.0, 0.0] }, // 4  | C
    { pos: [ 1.0, -1.0,  1.0], uv: [1.0, 0.0] }, // 5  | D

    { pos: [ 1.0,  1.0,  1.0], uv: [0.0, 1.0] }, // 6  | B | +x face
    { pos: [ 1.0, -1.0,  1.0], uv: [0.0, 0.0] }, // 7  | D
    { pos: [ 1.0,  1.0, -1.0], uv: [1.0, 1.0] }, // 8  | F
    { pos: [ 1.0,  1.0, -1.0], uv: [1.0, 1.0] }, // 9  | F
    { pos: [ 1.0, -1.0,  1.0], uv: [0.0, 0.0] }, // 10  | D
    { pos: [ 1.0, -1.0, -1.0], uv: [1.0, 0.0] }, // 11 | H

    { pos: [-1.0,  1.0, -1.0], uv: [0.0, 1.0] }, // 12 | E / +y face
    { pos: [-1.0,  1.0,  1.0], uv: [0.0, 0.0] }, // 13 | A
    { pos: [ 1.0,  1.0, -1.0], uv: [1.0, 1.0] }, // 14 | F
    { pos: [ 1.0,  1.0, -1.0], uv: [1.0, 1.0] }, // 15 | F
    { pos: [-1.0,  1.0,  1.0], uv: [0.0, 0.0] }, // 16 | A
    { pos: [ 1.0,  1.0,  1.0], uv: [1.0, 0.0] }, // 17 | B

    { pos: [ 1.0,  1.0, -1.0], uv: [0.0, 1.0] }, // 18 | F / -z face
    { pos: [ 1.0, -1.0, -1.0], uv: [0.0, 0.0] }, // 19 | H
    { pos: [-1.0,  1.0, -1.0], uv: [1.0, 1.0] }, // 20 | E
    { pos: [-1.0,  1.0, -1.0], uv: [1.0, 1.0] }, // 21 | E
    { pos: [ 1.0, -1.0, -1.0], uv: [0.0, 0.0] }, // 22 | H
    { pos: [-1.0, -1.0, -1.0], uv: [1.0, 0.0] }, // 23 | G
                                             
    { pos: [-1.0,  1.0, -1.0], uv: [0.0, 1.0] }, // 24 | E / -x face
    { pos: [-1.0, -1.0, -1.0], uv: [0.0, 0.0] }, // 25 | G
    { pos: [-1.0,  1.0,  1.0], uv: [1.0, 1.0] }, // 26 | A
    { pos: [-1.0,  1.0,  1.0], uv: [1.0, 1.0] }, // 27 | A
    { pos: [-1.0, -1.0, -1.0], uv: [0.0, 0.0] }, // 28 | G
    { pos: [-1.0, -1.0,  1.0], uv: [1.0, 0.0] }, // 29 | C
                                             
    { pos: [-1.0, -1.0,  1.0], uv: [0.0, 1.0] }, // 30 | C / -y face
    { pos: [-1.0, -1.0, -1.0], uv: [0.0, 0.0] }, // 31 | G
    { pos: [ 1.0, -1.0,  1.0], uv: [1.0, 1.0] }, // 32 | D
    { pos: [ 1.0, -1.0,  1.0], uv: [1.0, 1.0] }, // 33 | D
    { pos: [-1.0, -1.0, -1.0], uv: [0.0, 0.0] }, // 34 | G
    { pos: [ 1.0, -1.0, -1.0], uv: [1.0, 0.0] }, // 35 | H
];
...
const _rhombicDodecahedronGeometryVertices = [
    ...
    { pos: [ 0.0,  2.0,  0.0], uv: [0.0, 0.0] }, // 0  | N | -x, +y face
    ...
    { pos: [ 0.0,  2.0,  0.0], uv: [0.0, 0.0] }, // 6  | N | +y, +z face
    ...
    { pos: [ 0.0,  2.0,  0.0], uv: [0.0, 0.0] }, // 12 | N | +x, +y face
    ...
    { pos: [ 0.0,  2.0,  0.0], uv: [0.0, 0.0] }, // 18 | N | +y, -z face
    ...
    { pos: [ 0.0, -2.0,  0.0], uv: [0.0, 0.0] }, // 24 | M | -x, -y face
    ...
    { pos: [ 0.0, -2.0,  0.0], uv: [0.0, 0.0] }, // 30 | M | -y, +z face
    ...
    { pos: [ 0.0, -2.0,  0.0], uv: [0.0, 0.0] }, // 36 | M | +x, -y face
    ...
    { pos: [ 0.0, -2.0,  0.0], uv: [0.0, 0.0] }, // 42 | M | -y, -z face
    ...
    { pos: [-1.0,  1.0,  1.0], uv: [0.0, 0.0] }, // 48 | F | -x, +z face
    ...
    { pos: [ 1.0,  1.0,  1.0], uv: [0.0, 0.0] }, // 54 | G | +x, +z face
    ...
    { pos: [ 1.0,  1.0, -1.0], uv: [0.0, 0.0] }, // 60 | H | +x, -z face
    ...
    { pos: [-1.0,  1.0, -1.0], uv: [0.0, 0.0] }, // 66 | E | -x, -z face
